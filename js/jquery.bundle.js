...
+function(a) {
    ...
    if (!a.fn.tooltip)
        throw new Error("Popover%20requires%20tooltip.js");
    c.VERSION = "3.3.7",
...
!function(t, i) {
    ...
    r.prototype = {
        ...
        fit: function(t) {
            ...
            i = 0; i < e; i++)
                n = t[i],
                (r = this.findNode(this.root, n.w, n.h)) ? n.fit = this.splitNode(r, n.w, n.h) : n.fit = this.growDown(n.w, n.h)
        },
